...
- [ ] **L3b durable bounded stranded-work recovery — residual safety pass
  ...
  immutable policy. Recovery governance commits case → approval → issue state
  together before best-effort notifications. Crash cleanup is exact-run-first,
