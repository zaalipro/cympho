      ...
      <%= case @variant do %>
          ...
          <div class="space-y-3">
            <%= for _ <- 1..@rows do %>
              <div class="flex items-center gap-3 p-3 bg-surface border border-border rounded-lg">
                <div class="w-8 h-8 skeleton-shimmer rounded-md shrink-0"></div>
                <div class="flex-1 space-y-2">
                  <div class="h-3 skeleton-shimmer rounded w-3/4"></div>
                  <div class="h-2 skeleton-shimmer rounded w-1/2"></div>
                </div>
              </div>
            <% end %>
          </div>
        <% "card" -> %>
          <div class="p-4 bg-surface border border-border rounded-lg space-y-3">
            ...
            <div class="space-y-2">
              <div class="h-3 skeleton-shimmer rounded"></div>
              <div class="h-3 skeleton-shimmer rounded w-5/6"></div>
              <div class="h-3 skeleton-shimmer rounded w-4/6"></div>
            </div>
          </div>
        <% "issue" -> %>
          <div class="p-4 bg-surface border border-border rounded-lg">
            <div class="flex items-start gap-3">
              <div class="w-6 h-6 skeleton-shimmer rounded shrink-0 mt-0.5"></div>
              <div class="flex-1 space-y-2">
                ...
                <div class="h-3 skeleton-shimmer rounded w-1/2"></div>
              </div>
            </div>
          </div>
        <% "agent" -> %>
          <div class="p-4 bg-surface border border-border rounded-lg">
            <div class="flex items-center gap-3">
              ...
              <div class="w-2 h-2 skeleton-shimmer rounded-full"></div>
            </div>
          </div>
        <% "kanban" -> %>
          <div class="space-y-3">
            <div class="h-6 skeleton-shimmer rounded w-24 mb-2"></div>
            <div class="p-3 bg-surface border border-border rounded-lg">
              <div class="h-4 skeleton-shimmer rounded w-full mb-2"></div>
        ...
        <% "detail" -> %>
          <div class="space-y-4">
            <div class="flex items-center gap-3">
              <div class="h-8 skeleton-shimmer rounded w-24"></div>
              <div class="h-6 skeleton-shimmer rounded-full w-20"></div>
            </div>
            <div class="h-6 skeleton-shimmer rounded w-1/2"></div>
            <div class="space-y-2">
              <div class="h-4 skeleton-shimmer rounded"></div>
              <div class="h-4 skeleton-shimmer rounded"></div>
