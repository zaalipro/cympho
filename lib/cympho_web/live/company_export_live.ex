  ...
  def render(assigns) do
    ...
    <div class="p-6 lg:p-8 max-w-6xl mx-auto">
      ...
      <div class="space-y-6">
        ...
        <div :if={@download_ready && @export_data} class="bg-surface border border-border rounded-card p-6">
        ...
        <div class="bg-yellow-500/10 border border-yellow-500/20 text-yellow-400 rounded-card p-4 text-sm">
          <strong>Note:</strong> This export contains sensitive data. Store it securely and do not share it with unauthorized parties.
        </div>
      </div>
    </div>
    """
